...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    publicKeyTxt.text =
        geideaPublicKey = 'f7bdf1db-f67e-409b-8fe7-f7ecf9634f70';
    apiPasswordTxt.text =
        geideaApiPassword = '0c9b36c1-3410-4b96-878a-dbd54ace4e9a';
    super.initState();
  }
                  ...
                  Flexible(
                    ...
                    child: SizedBox(
                      ...
                      child: _getPlatformButton(
                          ...
                          (geideaApiPassword != '' && geideaPublicKey != '')
                              ? true
                              : false),
                    ),
                  ),
  ...
  _handleCheckout(BuildContext context) async {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              CheckoutFlow(geideaPublicKey, geideaApiPassword)),
    );
  }
  ...
  _handleApi(BuildContext context) async {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => ApiFlow(geideaPublicKey, geideaApiPassword)),
    );
  }
